...
var syntheticDivision_1 = require("./syntheticDivision");
var quadraticFormula_1 = require("./quadraticFormula");
...
*/
function reduce(polynomial, options) {
    ...
    while (curr.highestDegree() >= stopAtDegree) {
        var zeros = zeros_1.default(curr);
        ...
        var division = syntheticDivision_1.default(curr, divisor);
    ...
    if (options.quadraticFormula) {
        var quadratic = quadraticFormula_1.default(curr);
        steps.push({
